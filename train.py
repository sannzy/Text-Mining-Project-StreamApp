...
Original file is located at
    https://colab.research.google.com/drive/1l7IxUEPLN-H0axJ4xemJtbtnfurqGhWr
"""
...
def main(data_path="data.csv"):
    ...
    dl_model = Sequential([
        ...
        LSTM(64, dropout=0.2, recurrent_dropout=0.2) if tf.__version__ < '2.0' else LSTM(64),
    ...
    print("[DL] 7. Export DL artifacts (.h5, tokenizer, config)")
